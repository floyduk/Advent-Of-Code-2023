...
# This function figures out what kind of hand this is (pair, 2 pair, 3 of a kind etc) and returns
# a value indicating the rank of the hand for sorting purposes
def score_hand(hand):
    ...
    elif(match_list == [3,2] or match_list == [2,3]):
        return 5    # full house
    elif(match_list == [3]):
